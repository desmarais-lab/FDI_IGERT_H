...
\includegraphics[scale=.4, clip=true, trim=0cm 0cm 0cm 1.5cm]{figures/dv_hist.pdf}
\end{itemize}
...
\item For every year the model was fit, we saw a decrease in the Bayesian Information Criterion.
