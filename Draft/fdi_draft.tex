...
sum                           & $-21.22^{***}$ & $-23.15^{***}$ \\
                              & $(0.31)$       & $(0.28)$       \\
sum0.5                        & $238.63^{***}$ & $285.70^{***}$ \\
                              & $(4.18)$       & $(0.25)$       \\
mutual.geom.mean              & $11.69^{***}$  & $7.92^{***}$   \\
                              & $(0.62)$       & $(0.53)$       \\
edgecov.fdi\_net.mass.sum     &                & $0.05^{***}$   \\
                              &                & $(0.00)$       \\
edgecov.fdi\_net.distance.sum &                & $-0.11^{***}$  \\
                              &                & $(0.01)$       \\
\hline
AIC                           & -3030067.41    & -3029370.32    \\
BIC                           & -3030044.42    & -3029332.00    \\
Log Likelihood                & 1515036.71     & 1514690.16     \\
\hline
