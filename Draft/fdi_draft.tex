...
\begin{table}[ht]
\begin{tabular}{cccc}
\begin{subfigure}{0.4\textwidth}\centering\includegraphics[width=0.6\columnwidth]{draft_figures/rl_plots/Sum.pdf}\end{subfigure}\hspace{1em}%
\begin{subfigure}{0.4\textwidth}\centering\includegraphics[width=0.6\columnwidth]{draft_figures/rl_plots/Sum_5.pdf}\end{subfigure}\hspace{1em}%
\begin{subfigure}{0.4\textwidth}\centering\includegraphics[width=0.6\columnwidth]{draft_figures/rl_plots/Nonzero.pdf}\end{subfigure}\hspace{1em}%
\begin{subfigure}{0.4\textwidth}\centering\includegraphics[width=0.6\columnwidth]{draft_figures/rl_plots/Distance.pdf}\end{subfigure}\    \end{tabular}\caption{Results}
\label{tab:mytable}
\end{table}
}
