...
\section{Subsetting of Missingness Results}\label{qlevelresults}
...
\caption{\label{fig:q50plots} Estimates of terms when subsetting for \emph{q = 0.5}. Bars span 95\% confidence intervals. Black coefficient representations are from models excluding dependence terms (i.e., transitivity and reciprocity). All covariates are normalized between zero and one.}
...
\caption{\label{fig:q25plots} Estimates of terms when subsetting for \emph{q = 0.50} for Amelia imputations. Bars span 95\% confidence intervals. Black coefficient representations are from models excluding dependence terms (i.e., transitivity and reciprocity). All covariates are normalized between zero and one.}
