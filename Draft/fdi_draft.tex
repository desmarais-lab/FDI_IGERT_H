...
---that investments will flow disproportionately from state $i$ to $j$ when there are flows from state $i$ to third-party state $k$ and from state $k$ to $j$.
