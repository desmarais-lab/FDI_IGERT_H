...
\begin{figure}
\centering
\includegraphics[scale=.75]{draft_figures/BICdiff.pdf}
...
The coefficients estimated in the yearly count ERGMs are depicted in Figures \ref{fig:effectPlots1}--\ref{fig:effectPlots4}. None of the models fitted 
