...
\noindent \textbf{Addressed:} TODO  (Bruce) , Add a note that N/P develop a 'spatial' model that can model some of the dependencies---it could be extended to model ZI if dependencies were lagged, and that AMEN could be extended to address ZI. Be clear that ERGM is just one possible approach, but has distinct strength when it comes to the zero-dominated FDI data.
...
\noindent \textbf{Addressed:} TODO (John, can you discuss MI in detail?) Add more discussion of estimation, and GOF stats. \\
...
\noindent \textbf{Addressed:} TODO   (Bruce) discuss this, as well as referring to AMEN in the appendix \\
...
\noindent \textbf{Addressed:} TODO  (Bruce), add discussion of Count ERGM estimation \\
...
\noindent \textbf{Addressed:} TODO  (Bruce), clarify.\\
...
\noindent \textbf{Addressed:} TODO (John \& Bruce), John, could you run models and simulate using just the sum terms and covariates? I can make Figure 2 annual, and include reciprocity.  \\
...
\noindent \textbf{Addressed:}  TODO (Bruce), add GOF statistics \\
\\
