...
vars <- c("Sum", "Sum_5", "Nonzero", "Mutuality_OECD", "Mutuality_notOECD",
          ...
          "Dest_GDPpc", "Origin_GDPpc","Dest_inflation","Origin_inflation",
          "Dest_xr", "Origin_xr","Nodematch_OECD",
...
for(i in 1:25){
  ...
  #create plot object
  ggsave(paste("xr_rl_plots/",vars[i],".pdf", sep=""), 
