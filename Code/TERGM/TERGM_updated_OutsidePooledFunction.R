...
ncores=12
  ...
  save.image("TERGMResults116.RData")
  ...
  save.image("TERGMResults137.RData")
  ...
  save.image("TERGMResults148.RData")
  stopImplicitCluster()
  ...
  save.image("TERGMResults165.RData")
  
  AIC <- 2*length(coefs)-2*loglik
  
pooledERGMres <-  list(estimate=coefs,SE=SE,AIC=AIC,pooled.ergms=ergms.pooled)
